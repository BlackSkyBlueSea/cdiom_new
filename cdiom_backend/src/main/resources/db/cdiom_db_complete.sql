...
CREATE TABLE IF NOT EXISTS `inbound_record` (
    ...
    `second_confirm_time` DATETIME DEFAULT NULL COMMENT '第二人确认时间',
    `second_confirm_deadline` DATETIME DEFAULT NULL COMMENT '第二人确认截止时间',
    `second_reject_reason` VARCHAR(500) DEFAULT NULL COMMENT '第二人驳回原因',
